...
Generated from currently open non-draft PRs labeled `board-definition` in `micropython/micropython`.
...
|---|---|---|---|---|---|---|---|---|---|---|
| [#19026](https://github.com/micropython/micropython/pull/19026) | esp32 | esp32/boards: Add Pycom LoPy and LoPy4 board definitions with SX127x LoRa driver | Y | Y | Y | Y | Y | Yes | 2 | 16 |
| [#19012](https://github.com/micropython/micropython/pull/19012) | stm32 | stm32/boards/: Add  LCKFB_SKYSTAR_STM32F407VET6 boards. | Y | Y | Y | Y | Y | Yes | 2 | 13 |
| [#18940](https://github.com/micropython/micropython/pull/18940) | zephyr | `ports/zephyr: Add board config for Arduino UNO Q.` | N | N | N | Y | N | No | 2 | 5 |
| [#18871](https://github.com/micropython/micropython/pull/18871) | stm32 | Add GARATRONIC_PYMATE_CORE && GARATRONIC_PYMATE_16ADI16DO support | Y | Y | Y | N | Y | No | 2 | 11 |
| [#18829](https://github.com/micropython/micropython/pull/18829) | esp32 | esp32/boards: Add LILYGO T3-S3 board definition | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#18303](https://github.com/micropython/micropython/pull/18303) | stm32 | stm32: Add STM32H747I-DISCO board | Y | Y | Y | Y | Y | Yes | 2 | 15 |
| [#18090](https://github.com/micropython/micropython/pull/18090) | rp2 | rp2: boards: Add Soldered NULA RP2350 Board Definition | Y | Y | Y | Y | Y | Yes | 1 | 13 |
| [#18064](https://github.com/micropython/micropython/pull/18064) | rp2 | rp2: boards: Add W5100S-EVB-Pico2 board definition. | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#18035](https://github.com/micropython/micropython/pull/18035) | ports | ports/rp2/boards: Add WIZnet-EVB-boards and wiznet6k submodule | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#17857](https://github.com/micropython/micropython/pull/17857) | rp2 | adding support for the W55RP20_EVB_PICO. | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#17590](https://github.com/micropython/micropython/pull/17590) | stm32 | stm32/boards: Add WeAct_H723VG board support. | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#17001](https://github.com/micropython/micropython/pull/17001) | rp2 | rp2/boards/SOLDERPARTY_RP2350_STAMP_XL: Add new Solder Party board. | Y | Y | Y | Y | Y | Yes | 1 | 13 |
| [#16409](https://github.com/micropython/micropython/pull/16409) | renesas-ra | renesas-ra/boards/WEACT_RA4M1_CORE: Add board profile. | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#16407](https://github.com/micropython/micropython/pull/16407) | ports | ports/stm32/board/MPY_v11: Add new board MPY_v11 and acceleration IC. | Y | Y | Y | Y | Y | Yes | 2 | 15 |
| [#16325](https://github.com/micropython/micropython/pull/16325) | esp32 | add new board: ESP32_GENERIC_S3_N16R8_CAMERA | Y | Y | N | Y | Y | No | 2 | 12 |
| [#16124](https://github.com/micropython/micropython/pull/16124) | ports | ports/esp32/boards: Add WAVESHARE_ESP32_S3_PICO board configuration. | Y | Y | N | N | Y | No | 2 | 10 |
| [#15889](https://github.com/micropython/micropython/pull/15889) | samd | ports: adafruit grand central board support | Y | Y | Y | Y | Y | Yes | 2 | 13 |
| [#15516](https://github.com/micropython/micropython/pull/15516) | stm32 | I have added new stm32 boards(NUCLEO_H753xx) | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#15482](https://github.com/micropython/micropython/pull/15482) | ports | ports/nrf/boards/SUPERMINI_NRF52840 board definition + machine_bitstream. | Y | Y | Y | Y | Y | Yes | 2 | 14 |
| [#15443](https://github.com/micropython/micropython/pull/15443) | ports | ports/rp2/boards: Add ARCHI board by Newsan. | Y | Y | Y | N | Y | No | 2 | 10 |
| [#13361](https://github.com/micropython/micropython/pull/13361) | esp32 | esp32/boards: Add board definition for WalnutPi PicoW. | Y | Y | N | N | Y | No | 2 | 9 |
| [#13204](https://github.com/micropython/micropython/pull/13204) | ports | ports/esp32/boards: Add uPesy EDU ESP32 board. | Y | Y | Y | N | Y | No | 2 | 12 |
| [#12749](https://github.com/micropython/micropython/pull/12749) | ports | ports/rp2/boards/W5100S_EVB_PICO/mpconfigboard.cmake: Set default mode to HardWired | N | N | N | N | Y | No | 2 | 4 |
| [#12676](https://github.com/micropython/micropython/pull/12676) | stm32 | stm32/boards/ARDUINO_PORTENTA_H7: Update pin definitions. | N | N | Y | N | Y | No | 2 | 6 |
| [#12642](https://github.com/micropython/micropython/pull/12642) | samd | samd: Add board definition for Sparkfun SAMD51 MicroMod | Y | Y | Y | N | Y | No | 2 | 10 |
| [#12319](https://github.com/micropython/micropython/pull/12319) | rp2 | Board Definition Added for Pi-Plates MICROpi | Y | Y | Y | N | Y | No | 2 | 10 |
| [#12042](https://github.com/micropython/micropython/pull/12042) | esp32 | esp32/boards: Add support for XIAO ESP32S3/C3 boards. | Y | Y | N | N | Y | No | 2 | 9 |
| [#11398](https://github.com/micropython/micropython/pull/11398) | stm32 | NUCLEO-H7A3ZI-Q | N | Y | Y | N | Y | No | 2 | 8 |
| [#10752](https://github.com/micropython/micropython/pull/10752) | ports | ports/renesas-ra/boards/VK-RA6M3: Another New Board. | Y | Y | Y | N | Y | No | 2 | 12 |
| [#10665](https://github.com/micropython/micropython/pull/10665) | rp2 | rp2/boards/VCC_GND_RP2040: add VCC_GND_RP2040 with multiple variants. | Y | Y | Y | N | Y | No | 2 | 12 |
| [#10595](https://github.com/micropython/micropython/pull/10595) | ports | ports/renesas-ra/boards/VK-RA4W1: New board. | Y | Y | Y | N | Y | No | 2 | 11 |
| [#9859](https://github.com/micropython/micropython/pull/9859) | ports | ports/rp2/boards/ADAFRUIT_KB2040: Add Adafruit KB2040 board. | Y | Y | N | N | Y | No | 2 | 8 |
| [#9367](https://github.com/micropython/micropython/pull/9367) | stm32 | SMT32G4: Add USB, QPSI and AEMICS Board PYglet | Y | Y | Y | N | Y | No | 2 | 10 |
| [#9177](https://github.com/micropython/micropython/pull/9177) | esp32 | esp32/boards: Add LOLIN S3 ESP32-S3 based board. | Y | Y | N | N | Y | No | 2 | 9 |
| [#8822](https://github.com/micropython/micropython/pull/8822) | ports | ports/esp32/boards: Add supoprt to Franzininho WiFi WROVER(SPIRAM). | Y | Y | N | N | Y | No | 2 | 9 |
| [#8801](https://github.com/micropython/micropython/pull/8801) | esp32 | esp32: Add supoprt to Franzininho WiFi an ESP32-S2 based board | Y | Y | N | N | Y | No | 2 | 9 |
| [#7604](https://github.com/micropython/micropython/pull/7604) | rp2 | rp2/boards/PICO: Add USB VID/PID. | N | N | N | N | Y | No | 2 | 4 |
| [#7580](https://github.com/micropython/micropython/pull/7580) | rp2 | rp2/boards: Add Adafruit Trinkey QT2040. | N | Y | N | N | Y | No | 2 | 6 |
| [#7579](https://github.com/micropython/micropython/pull/7579) | rp2 | rp2/boards: Add Seeed XIAO RP2040. | N | Y | N | N | Y | No | 2 | 6 |
| [#7300](https://github.com/micropython/micropython/pull/7300) | esp32 | esp32/boards: Add board definition for ESP32-S2-Saola-1 | Y | Y | N | N | Y | No | 2 | 8 |
| [#7123](https://github.com/micropython/micropython/pull/7123) | stm32 | STM32L4: Support all STM32L4 MCUs with all features. Add NUCLEO boards. | N | Y | Y | N | Y | No | 2 | 8 |
| [#6677](https://github.com/micropython/micropython/pull/6677) | nrf | nrf/boards/waveshare_ble400: added board definition | N | Y | Y | N | Y | No | 2 | 8 |
| [#6488](https://github.com/micropython/micropython/pull/6488) | nrf | Add ports/nrf for BLYST840 nRF52840 Boards : | N | Y | Y | N | Y | No | 2 | 8 |
...
Scope: ports/rp2/boards/SOLDERPARTY_RP2350_STAMP_XL. Key files detected: board.json, mpconfigboard.h, board build config, pins.csv, manifest.py, variant configs. PR summary: Add Solder Party RP2350 Stamp XL board. This PR currently meets the minimum MUST criteria. Key gaps: board.json variants metadata for variant builds. Notable strengths: manifest.py included, variant configs included, variant pin-layout rule respected.
