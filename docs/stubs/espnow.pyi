"""
ESP-NOW wireless protocol support. See: https://docs.micropython.org/en/latest/library/espnow.html
...
# origin module:: /home/jimmo/src/github.com/micropython/micropython3/docs/library/espnow.rst
...
ADDR_LEN: Any = ...
"""(=6)"""
MAX_TOTAL_PEER_NUM: Any = ...
"""(=20)"""
MAX_ENCRYPT_PEER_NUM: Any = ...
"""(=6)"""
...
class ESPNow:
    ...
    **Note**: RSSI and timestamp values in the device table are updated only
    ...
    def active(self, flag: Optional[Any] = None) -> bool:
        """
    ...
    def irecv(self, timeout_ms: Optional[Any] = None) -> Any:
        ...
        *timeout_ms*: (Optional) Timeout in milliseconds (see `ESPNow.recv()`).
        ...
        Returns: As for `ESPNow.recv()`, except that ``msg`` is a bytearray, instead of
            a bytestring. On the ESP8266, ``mac`` will also be a bytearray.

        Raises: See `ESPNow.recv()`.
    ...
    def recvinto(self, data, timeout_ms: Optional[Any] = None) -> int:
        ...
        *timeout_ms*: (Optional) Timeout in milliseconds (see `ESPNow.recv()`).
        ...
        Returns length of message in bytes or 0 if *timeout_ms* is reached before a message is received.
    ...
    def stats(self) -> int:
        ...
        Returns A 5-tuple containing the number of packets sent/received/lost:
    ...
    def get_peer(self, mac) -> Any:
        ...
        Returns ``(mac, lmk, channel, ifidx, encrypt)``: a tuple of the "peer
    ...
    def get_peers(self) -> Tuple:
        ...
        """
        ...
    def mod_peer(self, mac, param=value, *args, **kwargs) -> Any:
        """
        ESP32 only.
