...
def test_ctrl_d_with_write_ctrl_d_method(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
    ...
    async def _test():
        ...
        result = await do_repl_main_loop_async(
            mock_state_with_async_transport, mock_console_with_queue, escape_non_printable=False
        )
        ...
        assert (
            mock_state_with_async_transport.transport.write_ctrl_d.call_args[0][0]
            == mock_console_with_queue.write
        )
...
def test_ctrl_d_without_write_ctrl_d_uses_write_async(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_ctrl_d_fallback_to_sync_serial(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_regular_input_with_mounted_filesystem(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_ctrl_j_code_injection_with_write_async(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_ctrl_j_code_injection_fallback_to_sync(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_ctrl_k_file_injection_with_async_methods(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
    ...
    async def _test():
        ...
        try:
            ...
            call_args = (
                mock_state_with_async_transport.transport.exec_raw_no_follow_async.call_args[0][0]
            )
...
def test_ctrl_k_file_injection_checks_async_first(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
...
def test_regular_input_fallback_to_sync_serial(
    mock_state_with_async_transport, mock_console_with_queue, event_loop, async_modules
):
