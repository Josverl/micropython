...
def main():
    ...
    parser.add_argument(
        "--samples-dir", default="organized_samples", help="Path to organized samples directory"
    )
    parser.add_argument(
        "--show-sample", help='Show content of samples matching pattern (e.g., "**/machine/*.py")'
    )
