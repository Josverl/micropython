...
As you likely want to build MicroPython, be sure to specify the correct
version of Zephyr (v4.2.0) during `west init`:
...
MicroPython port then try switching to the current supported version tag (v4.2.0)
